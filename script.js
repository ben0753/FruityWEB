...
var retrieveDefaultValuesFromLocalStorage = function() {
    try {
        var api_key = localStorage.getItem("rf.api_key") || "l7C0y07Thwda2CyAHThy";
        var model = localStorage.getItem("rf.model") || "fruits-quality-qtdtf";
        var format = localStorage.getItem("rf.format") || "json";
...
var setupButtonListeners = function() {
    ...
    // Make the buttons blue when clicked and toggle between "Select file" or "Enter URL" states
    $('.bttn').click(function() {
